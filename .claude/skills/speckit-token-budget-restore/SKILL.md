...
description: 'Restore one or more Spec-Driven Development artifacts to their original
  (pre-compaction) state from the <artifact>.full.md backups created by /compact.
  Deletes each backup after a successful restore.
