 ...
 * (dev/test) a caller with no role header is treated as PROCUREMENT_ADMIN so the service is usable before the
...
public class CallerContext {
  ...
  public CallerContext(@Value("${procurement.security.stub:true}") boolean stub) {
    this.stub = stub;
  }
