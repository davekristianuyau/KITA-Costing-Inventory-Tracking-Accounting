package com.kita.procurement.security;
...
import com.kita.procurement.security.ServiceCallRefusal.Reason;
...
class ServiceIdentityFilterTest {
  ...
  private static MockHttpServletRequest request() {
    MockHttpServletRequest request = new MockHttpServletRequest("POST", "/api/procurement/purchase-orders");
  ...
  void callerWithNoCertificateIsRefusedAndRecorded() throws Exception {
    ...
    assertThat(recorded.getRequestPath()).isEqualTo("/api/procurement/purchase-orders");
  }
