...
import com.kita.workflow.security.ServiceCallRefusal.Reason;
...
class ServiceIdentityFilterTest {
  ...
  private static MockHttpServletRequest request() {
    MockHttpServletRequest request = new MockHttpServletRequest("POST", "/api/workflow/sales-orders");
  ...
  void callerWithNoCertificateIsRefusedAndRecorded() throws Exception {
    ...
    assertThat(recorded.getRequestPath()).isEqualTo("/api/workflow/sales-orders");
  }
