...
import com.kita.hr.security.ServiceCallRefusal.Reason;
...
class ServiceIdentityFilterTest {
  ...
  private static MockHttpServletRequest request() {
    MockHttpServletRequest request = new MockHttpServletRequest("POST", "/api/hr/employees");
  ...
  void callerWithNoCertificateIsRefusedAndRecorded() throws Exception {
    ...
    assertThat(recorded.getRequestPath()).isEqualTo("/api/hr/employees");
  }
