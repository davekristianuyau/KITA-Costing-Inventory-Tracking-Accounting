...
class ServiceIdentityFilterTest {
  ...
  private static MockHttpServletRequest request() {
    MockHttpServletRequest request = new MockHttpServletRequest("POST", "/api/operations/sales-orders");
  ...
  void callerWithNoCertificateIsRefusedAndRecorded() throws Exception {
    ...
    assertThat(recorded.getRequestPath()).isEqualTo("/api/operations/sales-orders");
  }
